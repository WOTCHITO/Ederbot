...
mobile: MethodMobile, 
browser: opcion == '1' ? ['NexusBot', 'Edge', '20.0.04'] : methodCodeQR ? ['NexusBot', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
console.log('🍭 Nexus tiene Sub-Bots vinculados.');
return;
}
...
console.error(chalk.bold.cyanBright(`🥀 Error al iniciar NexusBot: `, error))
}
})();
